...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "neu-toggle-thumb pointer-events-none block h-5 w-5 translate-x-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
      )}
    />
  </SwitchPrimitives.Root>
))
NeumorphicToggle.displayName = SwitchPrimitives.Root.displayName
